    ...
    'groups' => [
        ...
        'features' => [
            ...
            'settings' => [
                ...
                'feature.tone_practice' => [
                    'label' => 'Tone practice',
                    'help' => 'Enable automated tone-practice games and scoring when the feature is production-ready.',
                    'type' => 'bool',
                    'default' => (bool) env('FEATURE_TONE_PRACTICE', false),
                ],
            ],
        ],
        'email' => [
