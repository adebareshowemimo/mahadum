...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private array $groups = [
        ...
        // view + vote are open to every signed-in user (no permission gate); only
        // organising/judging and entering are permissioned here.
        'competitions' => [
            'competitions.manage', // create competitions, moderate entries, judge
            'competitions.enter',  // submit a school play / diaspora folklore entry
        ],
    ...
    private function rolePermissionMap(): array
    {
        ...
        return [
            ...
            // Global curriculum authoring + lesson analytics. Also organises and
            // judges the national Language & Culture competition.
            'content_owner' => array_merge(
                $g('content', 'gamification'),
                ['learning.progress.view', 'analytics.lesson.view', 'competitions.manage']
            ),
            ...
            'parent' => array_merge(
                ...
                [
                    ...
                    'payouts.view',
                    'payouts.request',
                    'competitions.enter', // enter a child in the diaspora folklore category
                ]
            ),
